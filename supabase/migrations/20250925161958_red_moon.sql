/*
  # Add Stripe Membership and Marketplace System

  1. Extend Users Table
    - Add Stripe customer ID and membership status
    - Add Connect account ID for sellers
...
-- Extend auth.users table with Stripe and membership fields
DO $$
BEGIN
